...
exports.FlowChart = function (props) {
    ...
    var nodeCallbacks = { onDragNode: onDragNode, onDragStart: onDragStart, onDragStop: onDragStop, onNodeClick: onNodeClick, onNodeSizeChange: onNodeSizeChange };
